        ...
        >
          <div className="flex flex-col gap-1 items-center">
            <div className="flex items-center gap-2">
              <span className="font-script gold-text-shimmer gold-glow-text text-2xl font-normal lowercase first-letter:uppercase">15th August</span>
            ...
            <div className="flex items-center gap-2">
              <span className="font-script gold-text-shimmer gold-glow-text text-2xl font-normal lowercase first-letter:uppercase">16th August</span>
              <span className="text-[0.6rem] text-charcoal/40 font-light">|</span>
